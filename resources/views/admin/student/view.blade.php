...
@section('content')
    <div class="container pt-5 w-100 bg-white h-100" style="overflow-y:scroll;">
        <div class="d-flex pb-3 gap-5 align-items-center">
            <h4>VIEW STUDENT</h4>
            <p class="m-0">Home - Student List - View Student </p>
        </div>
        ...
        <div class="container-fluid pt-5 p-0 m-0 d-flex flex-column">
            <form action="" class="container-fluid pt-5 m-0 d-flex flex-column gap-3">
                {{-- FULLNAME --}}
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" placeholder="First Name"  name="fname" value="{{ old('fname')?old('fname'):$student->fname }}"
                        ...
                        <div class="col">
                            <input disabled type="text" placeholder="Middle Name (Optional)"  name="mname" value="{{ old('mname')?old('mname'):$student->mname }}"
                        ...
                        <div class="col">
                            <input disabled type="text" placeholder="Last Name"  name="lname" value="{{ old('lname')?old('lname'):$student->lname }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <select disabled name="gender" class="form-control @error('gender'){{ $class }}@enderror" >
                                <option value="" class="form-control" selected >Select</option>
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="date" name="bdate" placeholder="Select Birthdate" value="{{ old('bdate')?old('bdate'):$student->bdate }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" name="contact" placeholder="0938*****13" value="{{ old('contact')?old('contact'):$student->contact }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="email" name="email" placeholder="johndoe@gmail.com" value="{{ old('email')?old('email'):$student->user->email }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" name="text" placeholder="Street" value="{{ old('street')?old('street'):$student->street }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" name="region" placeholder="I,II,III..." value="{{ old('region')?old('region'):$student->region }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" name="province" placeholder="Ex. Camarines Norte"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" name="city" placeholder="Ex. Daet"value="{{ old('city')?old('city'):$student->city }}"
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <input disabled type="text" name="brgy" placeholder="Ex. Lag-On" value="{{ old('brgy')?old('brgy'):$student->brgy }}"
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <div class="btn-group w-100" role="group" aria-label="Type options">
                                ...
                                <input disabled {{ $student->type == 'old' ? 'checked' : '' }} type="radio" class="btn-check" name="type" id="old" value="old" required
                                    autocomplete="off">
                                <label class="btn btn-outline-primary" for="old">Old</label>

                                <input disabled {{ $student->type == 'new' ? 'checked' : '' }} type="radio" class="btn-check" name="type" id="new" value="new" required
                                    autocomplete="off">
                    ...
                    <div class="col-9 d-flex justify-content-even gap-3">
                        <div class="col">
                            <div class="btn-group w-100" role="group" aria-label="Grade level options">
                                ...
                                <input disabled {{ $student->level == 11 ? 'checked' : '' }} type="radio" class="btn-check" name="level" id="grade11" value="11" 
                                    autocomplete="off">
                                <label class="btn btn-outline-primary" for="grade11">Grade 11</label>

                                <input disabled {{ $student->level == 12 ? 'checked' : '' }} type="radio" class="btn-check" name="level" id="grade12" value="12" 
                                    autocomplete="off">
                        ...
                        <div class="col">
                            <div class="btn-group d-flex flex-column gap-2">
                                <div class="ps-0 form-check">
                                    <input disabled class="btn-check" type="radio" name="strand" id="strand-abm" value="ABM"  autocomplete="off"
                                ...
                                <div class="ps-0 form-check">
                                    <input disabled class="btn-check" type="radio" name="strand" id="strand-stem" value="STEM"  autocomplete="off"
                                ...
                                <div class="ps-0 form-check">
                                    <input disabled class="btn-check" type="radio" name="strand" id="strand-humss" value="HUMSS"  autocomplete="off"
                                ...
                                <div class="ps-0 form-check">
                                    <input disabled class="btn-check" type="radio" name="strand" id="strand-gas" value="GAS"  autocomplete="off"
                                ...
                                <div class="ps-0 form-check">
                                    <input disabled class="btn-check" type="radio" name="strand" id="strand-ict" value="ICT"  autocomplete="off"
                                ...
                                <div class="ps-0 form-check">
                                    <input disabled class="btn-check" type="radio" name="strand" id="strand-he" value="HE"  autocomplete="off"
