...
@section('content')
    <div class="w-100 h-100 p-5">
        ...
        <div class="d-flex gap-4 mb-4">
            <div class="container d-flex align-items-center p-3 text-white rounded" style="background:#37B6C4; height: 120px">
            ...
            <div class="container d-flex align-items-center p-3 text-white rounded" style="background:#2874B3; height: 120px">
            ...
            <div class="container d-flex align-items-center p-3 text-white rounded" style="background:#33BA5C; height: 120px">
        ...
        <div class="d-flex gap-4 justify-content-center">
            <div class="d-flex align-items-center p-3 text-white rounded" style="background:#E9D819; width: 350px; height: 120px">
                <i class="bi bi-backpack2-fill h1 text-white me-3"></i>
                <div class="d-flex flex-column w-100">
            ...
            <div class="d-flex align-items-center p-3 text-white rounded" style="background:#EA3865; width: 350px; height: 120px">
                <i class="bi bi-backpack2-fill h1 text-white me-3"></i>
                <div class="d-flex flex-column w-100">
