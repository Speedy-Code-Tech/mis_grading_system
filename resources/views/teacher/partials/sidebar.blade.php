<div class=" h-100 d-flex flex-column" style="height:100%; width:15%; background: #17908B;">
    ...
    <div class="container d-flex flex-column gap-3 pt-3 pe-0">
        ...
        <a href="{{ route('teacher.index') }}" class="{{ $active=='dashboard'?'active':'' }} p fw-bold ms-4 m-0" style="text-decoration: none; font-size: 1.2em;"><i class="bi bi-grid-1x2-fill"></i> Dashboard</a>
        ...
        <a href="{{ route('teacher.subject.index') }}" class="{{ $active=='subject'?'active':'' }} p fw-bold ms-4 m-0" style="text-decoration: none; font-size: 1.2em;"><i class="bi bi-book-half"></i> Subject</a>
