<div class=" h-100 d-flex flex-column" style="height:100%; width:100%; background: #17908B;">
    ...
    <div class="container d-flex flex-column gap-3 pt-3 pe-0">
        ...
        {{-- <a href="{{ route('student.index') }}" class="{{ $active=='dashboard'?'active':'' }} p-2 ps-3 fw-bold ms-4 rounded-start" style="text-decoration: none; font-size: 1.2em;"><i class="pe-2 bi bi-grid-1x2-fill"></i> Dashboard</a> --}}
        ...
        <a href="{{ route('student.subject.index') }}" class="{{ $active=='subject'?'active':'' }} p-2 ps-3 fw-bold ms-4 rounded-start" style="text-decoration: none; font-size: 1.2em;"><i class="pe-2 bi bi-book-half"></i> Subject</a>
        <form method="POST" action="{{ route('logout') }}">
            @csrf
        <button class="btn text-danger p-2 ps-3 fw-bold ms-4 rounded-start" style="position: absolute; bottom:20px; text-decoration: none; font-size: 1.2em;"><i class="pe-2 bi bi-box-arrow-left"></i> Logout</button>
        </form>
    </div>
</div>
<style>
