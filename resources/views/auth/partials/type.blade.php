       ...
       <div id="box1" class=" container h-75 mx-1 px-1">
        ...
        <div class="mt-5 pt-5 container-fluid d-flex gap-5 justify-content-around">
            ...
            <div class="container border rounded p-3 m-1 d-flex option" value="new" id="newStudent">
                ...
                <div class="container">
                    ...
                    <p>Are you a new student? Please click the continue button below to complete your registration.</p>
                </div>
            </div>
            ...
            <div class="container border rounded p-3 m-1 d-flex option" value="old" id="oldStudent">
                ...
                <div class="container">
                    ...
                    <p>Are you an old student? Please click the continue button below to complete your registration.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid text-end p-4">
            <div id='step1' class="btn text-white px-4 py-3" style="background:#189993; ">
                Submit 
                <img style="width:20px; margin-top:-3px" src="{{ asset('img/arrow.png') }}" />
            </div>
        </div>
    </div>
