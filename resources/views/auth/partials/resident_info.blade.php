...
<div id="box4" class=" container h-75 mx-1 px-1">
    ...
    <div class="container-fluid d-flex justify-content-between px-4 w-100">
        <div id="back3" class="btn text-white px-3 py-2 btn-sm" style="background:#6c757d;">
            Previous
        </div>
        <button type="submit" class="btn text-white px-3 py-2 btn-sm" style="background: #189993;">
            Submit
        </button>
    </div>
</div>
